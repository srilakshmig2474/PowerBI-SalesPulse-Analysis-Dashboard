...
- Analyze product and sub-category revenue
...
- 🛒 Total Orders: **10.00K**
- 📦 Total Products Sold: **9.20K**
- ↩️ Total Returned Orders: **800**
...
│
├── PowerBI/
│   └── Retail_Sales_SalesPulse_Dashboard.pbix
│
├── Screenshots/
│   ├── Retail_Sales_Overview.png
